...
/**
 * Modal component for students to ask AI questions about learning materials
 */
export default function AskAIModal({ isOpen, onClose, material }) {
                        ...
                        <>
                            <div className="flex gap-2">
                                <input
                                    ...
                                    disabled={loading}
                                    className="flex-1 px-4 py-3 rounded-xl border border-gray-200 focus:border-primary outline-none text-sm disabled:bg-gray-50"
                                />
                                <button
                                    onClick={handleAsk}
