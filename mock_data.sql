...
-- =====================================================
-- Grade 1 students (lower levels)
INSERT INTO progress (user_id, xp, total_xp, level, streak, last_activity_date, badges) VALUES
('00000000-0000-0000-0001-000000000001', 150, 150, 2, 3, CURRENT_DATE, ARRAY['50000000-0000-0000-0000-000000000001']::UUID[]),
('00000000-0000-0000-0001-000000000002', 80, 80, 1, 1, CURRENT_DATE - 1, ARRAY[]::UUID[]),
('00000000-0000-0000-0001-000000000003', 250, 250, 3, 5, CURRENT_DATE, ARRAY['50000000-0000-0000-0000-000000000001', '50000000-0000-0000-0000-000000000003']::UUID[]),
('00000000-0000-0000-0001-000000000004', 120, 120, 2, 2, CURRENT_DATE - 2, ARRAY['50000000-0000-0000-0000-000000000001']::UUID[]),
('00000000-0000-0000-0001-000000000005', 50, 50, 1, 0, CURRENT_DATE - 5, ARRAY[]::UUID[]),
('00000000-0000-0000-0001-000000000006', 180, 180, 2, 4, CURRENT_DATE, ARRAY['50000000-0000-0000-0000-000000000001']::UUID[]),
('00000000-0000-0000-0001-000000000007', 90, 90, 1, 1, CURRENT_DATE - 1, ARRAY[]::UUID[]),
('00000000-0000-0000-0001-000000000008', 200, 200, 2, 3, CURRENT_DATE, ARRAY['50000000-0000-0000-0000-000000000001', '50000000-0000-0000-0000-000000000003']::UUID[])
ON CONFLICT (user_id) DO UPDATE SET xp = EXCLUDED.xp, total_xp = EXCLUDED.total_xp, level = EXCLUDED.level, streak = EXCLUDED.streak;

-- Grade 2 students (higher levels)
INSERT INTO progress (user_id, xp, total_xp, level, streak, last_activity_date, badges) VALUES
('00000000-0000-0000-0002-000000000001', 520, 520, 6, 8, CURRENT_DATE, ARRAY['50000000-0000-0000-0000-000000000001', '50000000-0000-0000-0000-000000000002', '50000000-0000-0000-0000-000000000005', '50000000-0000-0000-0000-000000000007']::UUID[]),
('00000000-0000-0000-0002-000000000002', 380, 380, 4, 5, CURRENT_DATE, ARRAY['50000000-0000-0000-0000-000000000001', '50000000-0000-0000-0000-000000000003']::UUID[]),
...
('00000000-0000-0000-0002-000000000004', 320, 320, 4, 3, CURRENT_DATE - 1, ARRAY['50000000-0000-0000-0000-000000000001', '50000000-0000-0000-0000-000000000003']::UUID[]),
('00000000-0000-0000-0002-000000000005', 280, 280, 3, 2, CURRENT_DATE - 2, ARRAY['50000000-0000-0000-0000-000000000001']::UUID[]),
('00000000-0000-0000-0002-000000000006', 600, 600, 7, 12, CURRENT_DATE, ARRAY['50000000-0000-0000-0000-000000000001', '50000000-0000-0000-0000-000000000002', '50000000-0000-0000-0000-000000000003', '50000000-0000-0000-0000-000000000005', '50000000-0000-0000-0000-000000000006', '50000000-0000-0000-0000-000000000007']::UUID[]),
('00000000-0000-0000-0002-000000000007', 220, 220, 3, 1, CURRENT_DATE - 3, ARRAY['50000000-0000-0000-0000-000000000001']::UUID[]),
('00000000-0000-0000-0002-000000000008', 410, 410, 5, 6, CURRENT_DATE, ARRAY['50000000-0000-0000-0000-000000000001', '50000000-0000-0000-0000-000000000002', '50000000-0000-0000-0000-000000000003']::UUID[])
ON CONFLICT (user_id) DO UPDATE SET xp = EXCLUDED.xp, total_xp = EXCLUDED.total_xp, level = EXCLUDED.level, streak = EXCLUDED.streak;
